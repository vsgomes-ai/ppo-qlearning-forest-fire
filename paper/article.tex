...
agente tabular aproximado (por exemplo DQN) e comparar PPO versus DQN.
...
função; um DQN (ou outro método \emph{deep} tabular-aproximado) na observação
...
episódios de teste para estreitar intervalos; (iii)~um agente DQN na mesma
